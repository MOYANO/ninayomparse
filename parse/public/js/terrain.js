                                ...
                                for ( e= 0; e<4; e++ ) {
                                        ...
                                        for ( p = 0; p <4; p++ ) {
                                            ...
                                            materials[c]= new THREE.MeshBasicMaterial({
                                                          ...
                                                          ambient: 0xffffff,
                                                          map: THREE.ImageUtils.loadTexture( 'https://services.arcgisonline.com/arcgis/rest/services/World_Imagery/MapServer/tile/'+ level + "/" + ((plane.userData.fila*4) + e ) + '/' + ((plane.userData.columna*4) + p   ) +'.jpg'  , new THREE.UVMapping(),
                                                           function (ma) {
